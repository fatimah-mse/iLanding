...
export default function Hero() {
    return (
        <section className='min-h-screen pt-[100px] pb-15 px-20 max-[1366px]:px-14 max-[768px]:px-5 bg-[#acd5fc73] flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-wrap justify-between items-center mt-6 gap-4 p-6 rounded-2xl bg-white w-full'>
