...
export default function Hero() {
    return (
        <section className='min-h-screen pt-[84px] px-20 max-[1366px]:px-14 max-[768px]:px-5 max-[768px]:flex-col max-[768px]:justify-evenly bg-[#acd5fc73] flex justify-between items-center gap-5'>
            ...
            <Image src={illustration} alt="illustration" className='w-1/2 object-cover max-[768px]:w-full ms-auto' />
        </section>
    )
}
